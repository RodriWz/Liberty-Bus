            ...
            .map(
                ...
                <a href="#kontak" class="block group">
                    <div class="aspect-square bg-gray-100 overflow-hidden">
                        <img src="${bus.imageUrl}" alt="${bus.name}" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                    </div>
                    <div class="mt-3">
                        ...
                        <p class="text-gray-400 text-xs mt-1">${bus.facilities.length} fasilitas</p>
                    </div>
                </a>
            `,
            )
            ...
            <div class="bg-white">
                <div class="container mx-auto px-4 py-16">
                    <div class="flex justify-between items-end mb-8">
                        ...
                        <a href="#kontak" class="text-sm text-gray-500 hover:text-gray-700">Lihat semua →</a>
                    </div>
